...
This example is adapted by Jen Sykes from tthe Sparkfun Multiplexer example above making large numberr of inputs possible.
However, it can be easily converted to not include a multiplexer. 
******************************************************************************/
/////////////////////
// Pin Definitions //
/////////////////////
